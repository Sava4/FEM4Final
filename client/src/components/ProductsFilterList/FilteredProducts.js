...
export const FilteredListProducts = connect(MapStateToProps, {dispatchSetCheckFilter})(props => {
...
useEffect(() => { 
       const filterUurl = `http://localhost:5000/products/filter?${queryCategory}&${query}${sort}`;      
