const Cart = require("../../../../19.03 Final/FEM4Final/models/Cart");
const Order = require("../../../../19.03 Final/FEM4Final/models/Order");
const Product = require("../../../../19.03 Final/FEM4Final/models/Product");
const sendMail = require("../../../../19.03 Final/FEM4Final/commonHelpers/mailSender");
const validateOrderForm = require("../../../../19.03 Final/FEM4Final/validation/validationHelper");
const queryCreator = require("../../../../19.03 Final/FEM4Final/commonHelpers/queryCreator");
const productAvailibilityChecker = require("../../../../19.03 Final/FEM4Final/commonHelpers/productAvailibilityChecker");
const subtractProductsFromCart = require("../../../../19.03 Final/FEM4Final/commonHelpers/subtractProductsFromCart");
const _ = require("lodash");

const uniqueRandom = require("unique-random/index");
